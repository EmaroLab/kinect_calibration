...
int main(int argc, char* argv[])
{
	...
	tf::Quaternion calibration_rotation(-0.0708, -0.0511, -0.7052, 0.7036);
	tf::Vector3 calibration_translation(0.0337, 0.0294, 0.1247);
	...
	{
		publishState();
		br.sendTransform(tf::StampedTransform(tf::Transform(calibration_rotation, calibration_translation), ros::Time::now(), "head_camera", "cameraB_link"));
